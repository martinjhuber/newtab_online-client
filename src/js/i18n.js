...
const translations = {
    'en' : {
        ...
        'confirm_action' : 'Please confirm action',
        'confirm_delete_tile' : 'Do you really want to delete this tile?',
        'confirm_remove_tile_image' : 'Do you want to remove the image of this tile?',
    ...
    'de' : {
        ...
        'confirm_action' : 'Bitte Aktion bestätigen',
        'confirm_delete_tile' : 'Soll das Element wirklich gelöscht werden??',
        'confirm_remove_tile_image' : 'Soll das Bild zu dem Element wirklich entfernt werden?',
